      ...
      <View className={`space-y-3 ${ios? 'mb-6': 'mb-3'}`}>
          <View className="flex-row justify-between items-center px-4 mb-2">
              ...
              <View 
                ...
                <TouchableOpacity>
                  <MinusIcon size="20" strokeWidth={3} color={themeColors.text} onPress={subItem}/>
                </TouchableOpacity>
                <Text style={{color: themeColors.text}} className="font-extrabold text-lg">{countItem}</Text>
                <TouchableOpacity>
                  <PlusIcon size="20" strokeWidth={3} color={themeColors.text} onPress={addItem}/>
                </TouchableOpacity>
              </View>
          </View>
          {/* buy now button */}
